...
function Input_Decimal(dot) {
    //this ensures that accidental clicking of the decimal point doesnt cause bufs in your operation
...
function Handle_Operator(Next_Operator) {
    ...
    } else if (operator) {//checks if an operatyor already exists
    const Value_Now = First_Operand || 0;
//if operator exists, property lookip is performed for the operator 
//in the perfomr_calculation object and the function that matches the operator is executed
